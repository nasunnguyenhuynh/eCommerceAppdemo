    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shop', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='ecommerce.shop')),
                ('user_details', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='ecommerce.userdetails')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_details', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ecommerce.userdetails')),
            ],
        ),
        migrations.CreateModel(
            name='Voucher',
